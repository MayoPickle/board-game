...
export default function GoPage() {
  ...
  const handleJoinRoom = (roomId: string) => {
    ...
    router.push(`/games/go?room=${roomId}`);
    joinRoom(roomId);
  };
  ...
  const handlePass = () => {
    makeMove(-1, -1); // Special coordinates for pass move
  };

  // Custom GameRoom renderer for Go that includes the pass button
  const renderGoGameRoom = () => {
      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-24">
        <div className="game-container">
          <div className="text-center mb-8 slide-up">
            ...
            <h2 className="text-xl mb-2">围棋</h2>
          </div>
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-16">
      <div className="game-container">
        ...
        {isConnected && gameState && renderGoGameRoom()}
